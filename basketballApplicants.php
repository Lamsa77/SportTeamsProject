...
$sql = "SELECT id, FirstName, LastName, StudentID, DateOfBirth, Gender, Email, PhoneNumber, Department, Team FROM Applicants WHERE Team = 'Basketball'";
...
<head>
    ...
    <title>Handball Applicants</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No Basketball applicants found.</p>";
        }
