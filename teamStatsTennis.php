...
$sql = "SELECT season, team, win, loss, draw FROM AddStatsTennis ORDER BY season DESC, team ASC;";
...
<head>
    <meta charset="UTF-8">
    <title>Table Tennis Team Stats</title>
                ...
                var menChart = new Chart(menCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Men Table Tennis Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
                ...
                var womenChart = new Chart(womenCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Women Table Tennis Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
