...
$sql = "SELECT season, team, win, loss, draw FROM AddStatsSwimming ORDER BY season DESC, team ASC;";
...
<head>
    <meta charset="UTF-8">
    <title>Swimming Team Stats</title>
                ...
                var menChart = new Chart(menCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Men Swimming Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
                ...
                var womenChart = new Chart(womenCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Women Swimming Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
