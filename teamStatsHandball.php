...
$sql = "SELECT season, team, win, loss, draw FROM addStatsHandball ORDER BY season DESC, team ASC;";
...
<head>
    <meta charset="UTF-8">
    <title>Handball Team Stats</title>
                ...
                var menChart = new Chart(menCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Men Handball Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
                ...
                var womenChart = new Chart(womenCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Women Handball Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
