...
$sql = "SELECT season, win, loss, draw FROM AddStatsVolleyball ORDER BY season DESC;";
...
<head>
    <meta charset="UTF-8">
    <title>Volleyball Team Stats</title>
...
<body>
    <div class="index1">
        ...
        <div class="stats-container">
            <h1>Volleyball Team Stats</h1>
            <?php
            if (!empty($seasons)) {
                echo "<table class='stats-table'>";
                echo "<tr><th>Season</th><th>Wins</th><th>Losses</th><th>Draws</th></tr>";
