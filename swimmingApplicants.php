...
$sql = "SELECT id, FirstName, LastName, StudentID, DateOfBirth, Gender, Email, PhoneNumber, Department, Team FROM Applicants WHERE Team = 'Swimming'";
...
<head>
    ...
    <title>Swimming Applicants</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No Swimming applicants found.</p>";
        }
