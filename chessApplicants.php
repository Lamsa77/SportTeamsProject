...
$sql = "SELECT id, FirstName, LastName, StudentID, DateOfBirth, Gender, Email, PhoneNumber, Department, Team FROM Applicants WHERE Team = 'Chess'";
...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No Chess applicants found.</p>";
        }
