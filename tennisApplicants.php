...
// Query to fetch handball applicants
$sql = "SELECT id, FirstName, LastName, StudentID, DateOfBirth, Gender,
Email, PhoneNumber, Department, Team FROM Applicants WHERE Team = 'Table_Tennis'";
...
<head>
    ...
    <title>Table Tennis Applicants</title>
    <style>
        /* Global styles */
        body {
...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No Table Tennis applicants found.</p>";
        }
