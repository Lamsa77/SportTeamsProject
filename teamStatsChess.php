...
$sql = "SELECT season, team, win, loss, draw FROM AddStatsChess ORDER BY season DESC, team ASC;";
                ...
                var menChart = new Chart(menCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Men Chess Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
                ...
                var womenChart = new Chart(womenCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Women Chess Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
