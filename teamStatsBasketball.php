...
$sql = "SELECT season, team, win, loss, draw FROM addStatsBasketball ORDER BY season DESC, team ASC;";
...
<head>
    <meta charset="UTF-8">
    <title>Basketball Team Stats</title>
                ...
                var menChart = new Chart(menCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Men Basketball Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
                ...
                var womenChart = new Chart(womenCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Women Basketball Team Statistics'
                            },
                            legend: {
                                position: 'top',
                            }
